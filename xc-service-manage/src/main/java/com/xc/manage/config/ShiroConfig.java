...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        LOGGER.info("====shiroFilterFactoryBean注册开始====");
        // 定义 shiroFactoryBean
        ...
        // 配置可以匿名访问的地址，可以根据实际情况自己添加，放行一些静态资源等，anon 表示放行（不需要检验）
     ...
     * 配置shiro对密码的加密方式，要与数据库中密码的加密方式一致
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher(){
        ...
        hashedCredentialsMatcher.setHashIterations(1000);//散列的次数，比如散列两次，相当于
        return hashedCredentialsMatcher;
    }
